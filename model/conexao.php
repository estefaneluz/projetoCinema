<?php /*iniciando o codigo php p/ criar a conexão*/
    ...
    class dataBase  {/*classe  p/ conectar como banco*/
        private $userName="root";//login do banco padrão
        private $senha ="";
       
       //private: só a classe dataBase vai acessar
        public $conexao; // variável p/manipular a conexao
        //public: todo mundo tem acesso
        public function ConexaoBancoDeDados(){
            $this->conexao = null; // inicia o valor da conexão como nulo
            try{// trye - tenta executar o que tem dentro      //dbname seta o BD a ser utilizado  //permite a concexao como login do banco
            ...
            return $this->conexao;// retorna a conexão caso ela funcione
        }
    }   
